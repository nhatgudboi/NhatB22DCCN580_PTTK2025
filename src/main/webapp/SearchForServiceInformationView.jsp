...
<body>
    <div class="container">
        <h1>Search for Service Information</h1>
        
        <form method="get" action="service" class="search-form">
        ...
        <% if (request.getParameter("error") != null) { %>
            <div class="error">Error: Service not found or invalid ID.</div>
        <% } %>

        <% Service[] listService = (Service[]) request.getAttribute("listService"); %>
                ...
                <tbody>
                    <% for (Service service : listService) { %>
                        <tr>
                            ...
                            <td>
                                <a href="service?action=details&id=<%= service.getId() %>" class="action-link">View Details</a>
                            </td>
                        </tr>
                    <% } %>
                </tbody>
            </table>
        <% } else if (listService != null && listService.length == 0) { %>
